...
export type { WindowData, VueIntegrationAddons, BeautifiedUserAgent, ConsoleLogEvent, EventAddons, DefaultAddons, JavaScriptAddons, PhpAddons, NodeJSAddons, GoAddons, PythonAddons, SentryAddons, PerformanceIssueAddons, LongTaskAddon, LongAnimationFrameAddon, LoAFScriptEntry, WebVitalAddon };
